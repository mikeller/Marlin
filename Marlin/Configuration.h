...
#define STRING_CONFIG_H_AUTHOR "Michael Keller" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 19, 56, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
